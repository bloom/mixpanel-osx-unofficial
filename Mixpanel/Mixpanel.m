...
- (NSMutableDictionary *)collectAutomaticProperties
{
    ...
    [p setValue:[NSNumber numberWithInt:(int)screenRect.size.width] forKey:@"$screen_height"];
    [p setValue:[NSNumber numberWithInt:(int)screenRect.size.height] forKey:@"$screen_width"];
#endif
...
#else
        BOOL wifi = (flags & kSCNetworkReachabilityFlagsReachable);
#endif
